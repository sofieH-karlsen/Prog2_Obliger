...
public class TvSerieDataRepository implements TvSerieRepository{
    ...
    public void createData() {
        ...
        Episode csmEp1 = new Episode("Dog & Chainsaw","Denji is a teenager who lives his life as a Devil Hunter, to pay off his fathers debt, with his buddy, the chainsaw devil Pochita. He gets betrayed and killed by the yakuza. As Denji starts passing out, he hears someone calling from inside his head...",
                ...
                new Person("Ryuu Nakayama","1990"),new ArrayList<Rolle>(),"https://kbimages1-a.akamaihd.net/9b90e481-4b79-47e1-a919-3d0a46752177/1200/1200/False/chainsaw-man-vol-1.jpg");
        ...
        Episode csmEp2 = new Episode("Arrival in Tokyo","Denji arrives at the Devil Hunters Headquarters in Tokyo, and gets introduced to Aki Hayakawa, a senior hunter that he was supposed to partner with. But then Hayakawa beats Denji up, and demands that he “quit this job”...",
                ...
                new Person("Touko Yatabe","na"),new ArrayList<Rolle>(),"https://kbimages1-a.akamaihd.net/05f086d4-0b95-4966-9ee1-861c30afd7ca/1200/1200/False/chainsaw-man-vol-2.jpg");
        ...
        Episode csmEp3 = new Episode("Meowy's Wherabouts",
                ...
                new Person("Hironori Tanaka","1984"),new ArrayList<Rolle>(),"https://www.matsurinerd.com/73013-large_default/Chainsaw-Man-Vol-3-ITA-.jpg");
        ...
        Episode jjke1 = new Episode("Ryomen Sukuna",
                ...
                new Person("Gege Akutami","ukjent"),new ArrayList<Rolle>(),"https://kbimages1-a.akamaihd.net/44717797-1fe9-475e-bca1-fe8aa6d0e7d8/1200/1200/False/jujutsu-kaisen-vol-1.jpg");
        Episode jjke2 = new Episode("For Myself",
                ...
                new Person("Gege Akutami","ukjent"),new ArrayList<Rolle>(),"http://prodimage.images-bn.com/pimages/9781974710034_p0_v1_s1200x630.jpg");
        Episode jjke3 = new Episode("Girl of Steel",
                ...
                new Person("Gege Akutami","ukjent"),new ArrayList<Rolle>(),"https://kbimages1-a.akamaihd.net/47bf275b-1025-4ce4-bf29-416093f71b3f/353/569/90/False/jujutsu-kaisen-vol-3.jpg");
        Episode jjke4 = new Episode("Curse Womb Must Die",
                ...
                new Person("Gege Akutami","ukjent"),new ArrayList<Rolle>(),"https://kbimages1-a.akamaihd.net/b9f52e71-0658-4e21-9d3c-d25d9a51fd21/1200/1200/False/jujutsu-kaisen-vol-4.jpg");
        Episode jjke5 = new Episode("Curse Womb Must Die -II-",
                ...
                new Person("Gege Akutami","ukjent"),new ArrayList<Rolle>(),"https://m.media-amazon.com/images/I/51ZJp3AdtWL._AC_UF1000,1000_QL80_.jpg");
        Episode jjke6 = new Episode("After Rain",
                ...
                new Person("Gege Akutami","ukjent"),new ArrayList<Rolle>(),"https://kbimages1-a.akamaihd.net/3bbd8ec8-6cb6-48e2-956b-7721e3bcca3c/1200/1200/False/jujutsu-kaisen-vol-6.jpg");
        Episode jjke7 = new Episode("Assault",
                ...
                new Person("Gege Akutami","ukjent"),new ArrayList<Rolle>(),"https://kbimages1-a.akamaihd.net/38063b36-ba76-4cda-bcbc-096c1ea7adb1/1200/1200/False/jujutsu-kaisen-vol-7.jpg");
        Episode jjke8 = new Episode("Boredom",
                ...
                new Person("Gege Akutami","ukjent"),new ArrayList<Rolle>(),"https://kbimages1-a.akamaihd.net/22af78ba-0eeb-44e0-ab5e-20a4a890ade9/1200/1200/False/jujutsu-kaisen-vol-8.jpg");
        Episode jjke9 = new Episode("Small Fry and Reverse Retribution",
                ...
                new Person("Gege Akutami","ukjent"),new ArrayList<Rolle>(),"https://cdn.verasia.eu/17165-big_default_2x/jujutsu-kaisen-vol-9-sorcery-fight.jpg");
        Episode jjke10 = new Episode("Idle Transfiguration",
                ...
                new Person("Gege Akutami","ukjent"),new ArrayList<Rolle>(),"https://kbimages1-a.akamaihd.net/f27c8cab-7f00-46d6-b5d2-da78775ae154/1200/1200/False/jujutsu-kaisen-vol-10.jpg");
